            ...
            <div class="container-fluid">
                <div class="row align-items-center">
                    ...
                    <div class="col-sm-6 text-end">
                        <a href="{{ url('departement/assign_subject/add') }}" class="btn btn-info shadow-sm rounded-3">
                    ...
                    <form method="get" action="">
                        <div class="card-body">
                            <div class="row g-3">
                                ...
                                <div class="col-md-3">
                                    <label class="form-label fw-semibold">Class Name</label>
                                    <select name="class_name" class="form-select form-control">
                                        <option value="">Choisir une classe</option>
                                        @foreach ($classes as $class)
                                            <option value="{{ $class->name }}"
                                                {{ Request::get('class_name') == $class->name ? 'selected' : '' }}>
                            ...
                            <tbody>
                                @forelse ($getRecord as $value)
                                    <tr>
                                        ...
                                        <td style="min-width: 200px;">{{ $value->class_name }} {{ $value->class_opt }}
                                        </td>
                                        ...
                                        <td class="text-center" style="min-width: 200px;">
                                            <a href="{{ url('departement/assign_subject/edit/' . $value->id) }}"
                                                class="btn btn-info btn-sm me-1 mb-1" title="Edit">
                                                <i class="fas fa-pencil-alt"></i> Edit
                                            </a>
                                            <a href="{{ url('departement/assign_subject/edit_single/' . $value->id) }}"
                                                class="btn btn-primary btn-sm me-1 mb-1" title="Edit Single">
                                                <i class="fas fa-edit"></i> Edit Single
                                            </a>
                                            <a href="{{ url('departement/assign_subject/delete/' . $value->id) }}"
