            ...
            <div class="container-fluid">
                <div class="row align-items-center">
                    ...
                    <div class="col-sm-6 text-end">
                        <a href="{{ route('admin.jury.add') }}" class="btn btn-info shadow-sm rounded-3">
                            <i class="fa-solid fa-file-circle-plus me-2"></i> Ajouter un Jury
                        </a>
                    </div>
                </div>
            </div>
        ...
        <section class="content pb-5">
            <div class="container-fluid">
                ...
                <div class="card shadow-sm rounded-4 border-0 mb-4">
                    <div class="card-header bg-primary text-white rounded-top-4">
                        <h3 class="card-title mb-0">
                            <i class="fa-solid fa-magnifying-glass me-2"></i> Recherche Jury
                        </h3>
                    </div>
                        ...
                        <div class="card-body">
                            <div class="row g-3">
                                ...
                                <div class="col-md-4 d-flex align-items-end gap-2">
                                    ...
                                    <a href="{{ url('admin/jury/list') }}" class="btn btn-secondary w-100">
                                        Réinitialiser
                                    </a>
                                </div>
                            </div>
                ...
                <div class="card shadow-sm rounded-4 border-0">
                    <div class="card-header bg-primary text-white rounded-top-4">
                        <h3 class="card-title mb-0">
                            <i class="fa-solid fa-user-tie me-2"></i> Liste des Jury
                        </h3>
                    </div>
                            ...
                            <tbody>
                                @forelse ($getRecord as $index => $user)
                                    <tr>
                                        ...
                                        <td class="text-center">
                                            <a href="{{ route('admin.jury.edit', $user->id) }}"
                                                class="btn btn-info btn-sm me-1 mb-1" title="Modifier">
                                                <i class="fas fa-pencil-alt"></i>
                                            </a>
                                            <a href="{{ url('admin/jury/delete/' . $user->id) }}"
