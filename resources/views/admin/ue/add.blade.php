...
@section('content')
    <div class="content-wrapper">
        ...
        <section class="content">
            <div class="card">
                <div class="card-body">
                    <form method="POST" action="{{ route('admin.ue.insert') }}">
                        @csrf
                        ...
                        <div class="form-group">
                            ...
                            <select name="grade_scale" class="form-control" required>
                                <option value="LMD" {{ old('grade_scale') == 'LMD' ? 'selected' : '' }}>Système LMD
                                </option>
                                <option value="OTHER" {{ old('grade_scale') == 'OTHER' ? 'selected' : '' }}>Autre système
                                </option>
                            </select>
                        </div>
                        <div class="form-group">
