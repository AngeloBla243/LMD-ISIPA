            ...
            <div class="container-fluid">
                <div class="row mb-2">
                    ...
                    <div class="col-sm-6" style="text-align: right;">
                        <a href="{{ url('admin/assign_class_teacher/add') }}" class="btn btn-info"><i
                                class="fa-solid fa-file-circle-plus"></i> Add New Assign Class Teacher</a>
                    </div>
                                            ...
                                            <tr>
                                                ...
                                                <td style="min-width: 500px;">
                                                    ...
                                                    <a href="{{ url('admin/assign_class_teacher/edit_single/' . $value->id) }}"
                                                        class="btn btn-info"><i class="fas fa-edit"></i> Edit Single</a>

                                                    {{-- <a href="{{ url('admin/assign_class_teacher/assign_subject_subject') }}"
                                                        id="editTeacherLink" class="btn btn-warning"><i
                                                            class="fa-solid fa-book"></i> Assign Subject</a> --}}
