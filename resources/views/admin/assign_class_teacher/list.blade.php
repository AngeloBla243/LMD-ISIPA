                ...
                <div class="row align-items-center">
                    <div class="col-sm-6">
                        <h1 class="h3 fw-bold text-primary">
                            Assign Class Teacher ({{ $getRecord->total() }})
                        </h1>
                    </div>
                    <div class="col-sm-6 text-end">
                        <a href="{{ url('admin/assign_class_teacher/add') }}" class="btn btn-info shadow-sm rounded-3">
                            <i class="fa-solid fa-file-circle-plus me-2"></i> Add New Assign Class Teacher
                        </a>
                    </div>
                </div>
            </div>
                ...
                <div class="row">
                    <div class="col-12">
                        ...
                        <div class="card shadow-sm rounded-4 border-0 mb-4">
                            <div class="card-header bg-primary text-white rounded-top-4">
                                <h3 class="card-title mb-0">
                                    <i class="fa-solid fa-magnifying-glass me-2"></i>Search Assign Class Teacher
                                </h3>
                            </div>
                        ...
                        <div class="card shadow-sm rounded-4 border-0">
                            <div class="card-header bg-primary text-white rounded-top-4">
                                <h3 class="card-title mb-0">
                                    <i class="fa-solid fa-list-ul me-2"></i>Assign Class Teacher List
                                </h3>
                            </div>
                                        ...
                                        @foreach ($getRecord as $value)
                                            <tr>
                                                ...
                                                <td style="min-width: 200px;">{{ $value->class_name }}
                                                    {{ $value->class_opt }}</td>
                                                <td style="min-width: 200px;">{{ $value->teacher_name }}
                                                    {{ $value->teacher_last_name }}</td>
                                                ...
                                                <td style="min-width: 200px;">{{ $value->subject_name ?? 'N/A' }}</td>
                                                <td style="min-width: 200px;">{{ $value->subject_code ?? 'N/A' }}</td>
                                                ...
                                                <td class="text-center" style="min-width: 300px;">
                                                    <a href="{{ url('admin/assign_class_teacher/edit/' . $value->id) }}"
                                                        class="btn btn-primary btn-sm me-1 mb-1" title="Edit">
                                                        <i class="fas fa-pencil-alt"></i> Edit
                                                    </a>
                                                    <a href="{{ url('admin/assign_class_teacher/edit_single/' . $value->id) }}"
                                                        class="btn btn-info btn-sm me-1 mb-1" title="Edit Single">
                                                        <i class="fas fa-edit"></i> Edit Single
                                                    </a>
                                                    <a href="{{ url('admin/assign_class_teacher/assign_subject_subject/' . $value->teacher_id) }}"
                                                        class="btn btn-warning btn-sm me-1 mb-1" title="Assign Subject">
                                                        <i class="fa-solid fa-book"></i> Assign Subject
                                                    </a>
