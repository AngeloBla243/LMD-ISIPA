                ...
                <div class="card shadow-sm rounded-4 border-0 mx-auto" style="max-width: 600px;">
                    <form
                        ...
                        <div class="card-body">
                            ...
                            <div class="mb-4">
                                <label for="is_active" class="form-label fw-semibold">Année active ?</label>
                                <select name="is_active" id="is_active"
                                    class="form-select @error('is_active') is-invalid @enderror">
                                    <option value="1"
                                        {{ old('is_active', $academicYear->is_active ?? '') == 1 ? 'selected' : '' }}>Oui
                                    </option>
                                    <option value="0"
                                        {{ old('is_active', $academicYear->is_active ?? '') == 0 ? 'selected' : '' }}>Non
                                    </option>
                                </select>
                                @error('is_active')
                                    <div class="invalid-feedback">{{ $message }}</div>
