            ...
            <div class="container-fluid">
                <div class="row mb-2">
                    ...
                    <div class="col-sm-6" style="text-align: right;">
                        <a href="{{ url('admin/assign_subject/add') }}" class="btn btn-info"><i
                                class="fa-solid fa-file-circle-plus"></i> Add New Assign Subject</a>
                    </div>
                                            ...
                                            <tr>
                                                ...
                                                <td style="min-width: 400px;">
                                                    ...
                                                    <a href="{{ url('admin/assign_subject/edit_single/' . $value->id) }}"
                                                        class="btn btn-primary"><i class="fas fa-edit"></i> Edit Single</a>
